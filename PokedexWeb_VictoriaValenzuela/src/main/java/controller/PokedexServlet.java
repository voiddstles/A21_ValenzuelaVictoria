...
public class PokedexServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Pokemon nuevoPokemon = new Pokemon(nombre, numero, tipo, imageUrl);
        HttpSession session = request.getSession();
        List<Pokemon> pokedex = (List<Pokemon>) session.getAttribute("pokedex");
        if(pokedex == null){
            pokedex = new ArrayList<>();
        }
        pokedex.add(nuevoPokemon);
        session.setAttribute("pokedex", pokedex);
